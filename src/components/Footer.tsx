export default function Footer() {
  return (
    <footer className="border-t border-white/10 bg-[#0a0e16]">
      <div className="max-w-[1440px] mx-auto px-6 py-10 grid grid-cols-1 md:grid-cols-4 gap-8 text-[13px]">
        <div>
        ...
        <div>
          ...
          <div className="flex flex-col gap-2 text-[#bacbbe]"><span>7.4 kW • 32A • 230V</span><span>IEC 61851 • IP54 • IK08</span><span>OCPP 1.6J • RFID • OTA</span><span>Stitch Project: 15753018976447506990</span></div>
        </div>
        <div>
