...
export default function Hero() {
  return (
    <section id="solutions" className="relative w-full overflow-hidden pt-28">
      <div className="absolute -top-32 left-1/2 -translate-x-1/2 w-[1000px] h-[480px] bg-[#00e699]/10 blur-[130px] pointer-events-none rounded-full" />
      <div className="absolute inset-0 grid-bg opacity-60 pointer-events-none" />
      <div className="max-w-[1440px] mx-auto px-6 py-10 relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
        <motion.div
        ...
        >
          ...
          <h1 className="font-display font-extrabold tracking-tight leading-[1.08] text-[36px] sm:text-[56px]">
          ...
          <div className="p-4 rounded bg-[#181c24] grid grid-cols-2 md:grid-cols-4 gap-3 mt-2">
            {[
              ...
              <div key={a}>
                <div className="font-mono text-[13px] font-bold">{a}</div>
                <div className="font-mono text-[11px] text-[#bacbbe]">{b}</div>
              </div>
            ))}
          </div>
        </motion.div>
